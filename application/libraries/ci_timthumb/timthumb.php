...
if(! defined('FILE_CACHE_ENABLED') ) 		define ('FILE_CACHE_ENABLED', ENVIRONMENT == 'production' ? TRUE : FALSE );					// Should we store resized/modified images on disk to speed things up?
